...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$320000$e793SRq6R1CLEHe25Zj2F4$BLiTJGHeSheU/jmVREltulsWocFt8OWZROJ7SFYYsUg=','2022-08-02 19:03:56.246802',1,'mona','','','mona.aman251@gmail.com',1,1,'2022-08-02 19:02:11.167144');
...
-- Dump completed on 2022-08-06 18:51:06
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: localhost    Database: ment
-- ------------------------------------------------------
...
-- Dump completed on 2022-08-06 18:51:04
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: localhost    Database: ment
-- ------------------------------------------------------
...
CREATE TABLE `mentee` (
  `id` int NOT NULL,
  `menteeName` varchar(1000) NOT NULL,
  `status` varchar(1000) DEFAULT NULL,
  `proficiency_status` varchar(1000) DEFAULT NULL,
  `hire_status` varchar(1000) DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `mentee_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mentor` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `mentor_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `request` (
  ...
  `help_with` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `specilization` varchar(1000) NOT NULL,
...
CREATE TABLE `userinput` (
  `id` int NOT NULL,
  `opp_title` varchar(1000) DEFAULT NULL,
  `pay_status` varchar(1000) DEFAULT NULL,
  `currency` varchar(1000) DEFAULT NULL,
  `location` varchar(1000) DEFAULT NULL,
  `duration` varchar(1000) DEFAULT NULL,
  `opp_status` varchar(1000) DEFAULT NULL,
  `comments_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `comments_id_idx` (`comments_id`),
  CONSTRAINT `comments_id` FOREIGN KEY (`comments_id`) REFERENCES `comments` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zone` (
  `id` int NOT NULL,
  `zone_title` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
